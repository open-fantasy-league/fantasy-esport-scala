...
//
//case class LeagueUserFormInput(leagueId: Int, userId: Int)
//
//case class UpdateLeagueUserFormInput(name: Option[String], isPrivate: Option[Boolean],
...
//
//  private val form: Form[LeagueUserFormInput] = {
//
//    Form(
//      mapping(
//        "leagueId" -> number,
